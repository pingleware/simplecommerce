...
<html lang="en">
    <head>
        <title><?php echo strtoupper($settings['sitename']); ?>: Returns</title>
        <meta charset="UTF-8">
    ...
    <body class="w3-content" style="max-width:1200px">
        ...
        <div class="w3-main" style="margin-left:250px">
            ...
            <header class="w3-container w3-xlarge">
                <p class="w3-left">Order Cancelled</p>
                <p class="w3-right">
            ...
            <div class="w3-display-container w3-container">
                <img src="images/cancellation.jpg" alt="Jeans" style="width:100%">
            ...
            <div class="w3-row w3-grayscale">
                ...
                <?php echo $settings['cancel_page_content']; ?>
            </div>
