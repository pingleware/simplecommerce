...
var FingerprintJS = (function (e) {
    ...
    function B(e) {
        ...
        return t(this, void 0, void 0, function () {
            ...
            return r(this, function (r) {
                switch (r.label) {
                    case 0:
                        for (t = document, o = t.createElement("div"), a = new Array(e.length), c = {}, _(o), s = 0; s < e.length; ++s)
                            "DIALOG" === (u = A(e[s])).tagName && u.show(), _((l = t.createElement("div"))), l.appendChild(u), o.appendChild(l), (a[s] = u);
                        r.label = 1;
                    case 1:
    ...
    var te = {
        ...
        timezone: function () {
            ...
            var r,
                o = ((r = new Date().getFullYear()), -Math.max(g(new Date(r, 0, 1).getTimezoneOffset()), g(new Date(r, 6, 1).getTimezoneOffset())));
        ...
        platform: function () {
            ...
            return "MacIntel" === e && F() && !M()
                ? (function () {
                      ...
                      var e = screen,
                          n = e.width / e.height;
                      return L(["MediaSource" in window, !!Element.prototype.webkitRequestFullscreen, n > 0.65 && n < 1.53]) >= 2;
                  })()
                    ? "iPad"
                    : "iPhone"
                : e;
        ...
        vendorFlavors: function () {
            for (
                var e = [], n = 0, t = ["chrome", "safari", "__crWeb", "__gCrWeb", "yandex", "__yb", "__ybro", "__firefox__", "__edgeTrackingPreventionStatistics", "webkit", "oprt", "samsungAr", "ucweb", "UCShellJava", "puffinDevice"];
                n < t.length;
                n++
            ) {
                var r = t[n],
        ...
        videoCard: function () {
            ...
            if (t && "getExtension" in t) {
                ...
                if (r) return { vendor: (t.getParameter(r.UNMASKED_VENDOR_WEBGL) || "").toString(), renderer: (t.getParameter(r.UNMASKED_RENDERER_WEBGL) || "").toString() };
            }
        },
