...
<html lang="en">
    <head>
        <title><?php echo strtoupper($settings['sitename']); ?>: Shipment</title>
        <meta charset="UTF-8">
    ...
    <body class="w3-content" style="max-width:1200px">
        ...
        <div class="w3-main" style="margin-left:250px">
            ...
            <div class="w3-display-container w3-container">
                <img src="images/shipment.jpg" alt="Jeans" style="width:100%">
            ...
            <div class="w3-row w3-grayscale">
                <h1>Shipment</h1>
                <?php echo $settings['shipment_page_content']; ?>
            </div>
