...
$currentStatus = "Order Received"; // initial status
$statusNotes = "";
...
if ($_GET['session_id']) {
    ...
    try {
        ...
        if ($row === false) {
            $stmt = $db->prepare('INSERT INTO tracker (session_id) VALUES (:session_id)');
            $stmt->bindValue(':session_id', $session_id);
            $stmt->execute();
        } else {
         ...
         * 
         * prividing extra incentivizing processing, for example
...
<html lang="en">
    <head>
        <title><?php echo strtoupper($settings['sitename']); ?>: Order Fulfillment Tracker</title>
        <meta charset="UTF-8">
    ...
    <body class="w3-content" style="max-width:1200px">
        ...
        <div class="w3-main" style="margin-left:250px">
            ...
            <header class="w3-container w3-xlarge">
                <p class="w3-left">Order Fulfillment Tracker</p>
                <p class="w3-right">
            ...
            <div class="w3-display-container w3-container">
                <img src="images/fulfillment-tracker.jpg" alt="Jeans" style="width:100%">
            ...
            <div class="w3-row w3-grayscale">
                ...
                foreach ($statuses as $status) {
                    ...
                    echo "<div class='segment $class'>$status</div>";
                }
                ?>
                </div>
            </div>
            <fieldset>
                ...
                <p class="w3-panel" id="notes"><?php echo htmlentities($statusNotes); ?></p>
            </fieldset>
            <br/>
